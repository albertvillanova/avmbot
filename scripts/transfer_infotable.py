...
LIST_OF_CAPTAINS_GENERAL_OF_CATALONIA, CAPTAIN_GENERAL_OF_CATALONIA = 'Q43189497', 'Q2937345'
COUNTY_OF_CARCASSONNE,  COUNT_OF_CARCASSONNE = ('Q38697063', 'Q38697206')
COUNTY_OF_FOIX, COUNT_OF_FOIX = ('Q1481436', 'Q24851389')
KINGDOM_OF_ISRAEL, KING_OF_ISRAEL = ('Q230407', 'Q26835654')
KINGDOM_OF_JUDAH, KING_OF_JUDAH = ('Q48685', 'Q10550167')
MINISTRY_OF_FOREIGN_AFFAIRS_OF_ANGOLA, MINISTER_OF_FOREIGN_AFFAIRS_OF_ANGOLA = ('Q6866918', 'Q54417158')  # wrong link
FIX_POSITION_VALUE = {
    ARCHBISHOP: CATHOLIC_ARCHBISHOP,
    LIST_OF_CAPTAINS_GENERAL_OF_CATALONIA: CAPTAIN_GENERAL_OF_CATALONIA,
    COUNTY_OF_CARCASSONNE: COUNT_OF_CARCASSONNE,
    COUNTY_OF_FOIX: COUNT_OF_FOIX,
    KINGDOM_OF_ISRAEL: KING_OF_ISRAEL,
    KINGDOM_OF_JUDAH: KING_OF_JUDAH,
    MINISTRY_OF_FOREIGN_AFFAIRS_OF_ANGOLA: MINISTER_OF_FOREIGN_AFFAIRS_OF_ANGOLA,
}
                    ...
                    for new_statement_qualifier in new_statement.qualifiers:
                        if new_statement_qualifier.property in common_qualifier_properties:
                            ...
                            if not equal_qualifiers:  # if any of the common qualifiers is different
                                logger.info(f"Skip statement: any of the common qualifiers is different: "
